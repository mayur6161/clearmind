...
import 'notifier_two/play_button_notifier.dart';
import 'notifier_two/progress_notifier.dart';
import 'notifier_two/repeat_button_notifier.dart';
...
class Playlist_two extends StatefulWidget {
  @override
  _Playlist_twoState createState() => _Playlist_twoState();
}

// use GetIt or Provider rather than a global variable in a real project
late PageManager _pageManager;

class _Playlist_twoState extends State<Playlist_two> {
  @override
  void initState() {
    super.initState();
